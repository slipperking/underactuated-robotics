...
#import "src/core/item-lib.typ": elabel, item, ref-enum //level, level-count, list-level, ref-enum
...
#import "src/export-el.typ": (
  default-enum, default-enum-list, default-list, paragraph-enum, paragraph-enum-list, paragraph-list,
)
